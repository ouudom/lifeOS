    ...
    <SidebarMenu>
      <SidebarMenuItem>
        <DropdownMenu>
            ...
            >
              <div className="bg-sidebar-primary text-sidebar-primary-foreground flex aspect-square size-8 items-center justify-center rounded-lg transition-all group-data-[collapsible=icon]:rounded-md">
                <Bot/>
              </div>
